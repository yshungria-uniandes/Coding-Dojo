...
class User:
    ...
    def create_user(cls,data):
        query = '''
                ...
                '''
        response_query_users = connectToMySQL('login_register_schema').query_db(query,data)
    ...
    def get_user_by_email(cls,data):
        query = '''
                ...
                '''
        response_user=connectToMySQL('login_register_schema').query_db(query,data)
    ...
    def validate_registration(registro):      
        query = '''
                SELECT * FROM users WHERE email=%(email)s
                '''
        response_query_user=connectToMySQL('login_register_schema').query_db(query,registro)
    ...
    def validate_login(login):
        ...
        query = '''
                SELECT * FROM users WHERE email=%(email)s
                '''
        response_query_user=connectToMySQL('login_register_schema').query_db(query,login)
